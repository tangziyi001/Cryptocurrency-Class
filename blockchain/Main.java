...
public class Main {
   ...
   public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
        ...
        for (int i = 0; i < 10; i++) {
            Block block = new Block(genesis.getHash(), pk_alice.getPublic());
            ...
            tx.addOutput(5, pk_alice.getPublic());
            tx.addOutput(10, pk_alice.getPublic());
            tx.addOutput(10, pk_alice.getPublic());
            ...
            block.finalize();
            System.out.println("Block Added ok: " + bh.processBlock(block));
        }
        System.out.println("Block Created ok: " + bh.createBlock(pk_alice.getPublic()));
